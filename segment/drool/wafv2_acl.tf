...
resource "aws_wafv2_web_acl" "main" {
  ...
  name     = "web_acl-${var.project_code}-${var.environment}${var.zone}${var.tier}"
  scope    = var.scope
    ...
    content {
      ...
      dynamic "visibility_config" {
        ...
        content {
          ...
          metric_name                = lookup(visibility_config.value, "metric_name", "rule-metric-${var.project_code}${var.environment}${var.zone}${var.tier}")
  ...
  dynamic "visibility_config" {
    ...
    content {
      cloudwatch_metrics_enabled = lookup(visibility_config.value, "cloudwatch_metrics_enabled", true)
      metric_name                = lookup(visibility_config.value, "metric_name", "web-acl-metric-${var.project_code}${var.environment}${var.zone}${var.tier}")
      sampled_requests_enabled   = lookup(visibility_config.value, "sampled_requests_enabled", true)
    }
  }
}
